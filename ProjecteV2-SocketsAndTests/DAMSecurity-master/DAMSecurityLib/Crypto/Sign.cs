...
namespace DAMSecurityLib.Crypto
{
    ...
    public class Sign
    {
        ...
        public X509Certificate2 InitCertificate(string pfxFileName, string pfxPassword)
        {
        ...
        public static byte[] SignDocument(X509Certificate2 certificate, byte[] document)
        {
