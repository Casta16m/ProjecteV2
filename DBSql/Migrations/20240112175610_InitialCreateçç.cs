...
{
    /// <inheritdoc />
    public partial class InitialCreateçç : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtistaNom = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    albumsNomAlbum = table.Column<string>(type: "nvarchar(25)", nullable: false),
                    albumsdata = table.Column<DateTime>(type: "datetime2", nullable: false),
                    albumsArtistaNom = table.Column<string>(type: "nvarchar(25)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumSong", x => new { x.songsUID, x.albumsNomAlbum, x.albumsdata, x.albumsArtistaNom });
                    table.ForeignKey(
                        name: "FK_AlbumSong_Album_albumsNomAlbum_albumsdata_albumsArtistaNom",
